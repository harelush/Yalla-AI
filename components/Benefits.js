      ...
      <div className="container-max">
        ...
        >
          {content.benefits.items.map((benefit, index) => (
            ...
            >
              {/* Icon */}
              <div className="text-5xl mb-2 group-hover:animate-bounce text-center">
                {benefit.icon}
              </div>

              {/* Title */}
              <h3 className="text-2xl font-bold mb-2 text-text-dark group-hover:text-primary transition-colors font-header text-center">
                {benefit.title}
              </h3>
